...
var CommonHelper = {
	...
	*/	
	...
	/**
	 * Returns position if value exists in array. Value can be a date then dateInArray is called
	 * @public
	 * @param {any} v
	 * @param {array} ar
	 * @returns int position or -1
	...
	,constructorName: function(o) {
		return (o.constructor && o.constructor.name && o.constructor.name.length)? o.constructor.name : this.functionName(o.constructor);
	}
	...
	,setCookie: function(c_name, c_val, c_age, c_path) {	
		if(!c_path){
			c_path = '/';
		}
		if(c_age == undefined){
		...
		document.cookie = c_name+'='+encodeURIComponent(c_val)+'; Max-Age='+c_age+'; path='+c_path+';SameSite=None; secure;';
	}
	,unsetCookie: function(c_name, c_path) {
		if(!c_path){
			c_path = '/';
		}
		document.cookie = c_name+'=; Max-Age=0; path='+c_path;
	}
	...
	/**
	  ...
	  */
	,calculateImgRatioFit: function(srcWidth, srcHeight, maxWidth, maxHeight) {
