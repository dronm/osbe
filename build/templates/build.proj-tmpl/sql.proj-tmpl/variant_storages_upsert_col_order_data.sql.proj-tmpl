...
$BODY$
  ...
  COST 100;
ALTER FUNCTION variant_storages_upsert_col_order_data(in_user_id int, in_storage_name text, in_variant_name text, in_col_order_data text, in_default_variant boolean) OWNER TO ;
